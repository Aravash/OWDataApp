...
class HeroActivity : AppCompatActivity(), Adapter.OnItemClickListener
{
    ...
    private fun generateExpandable( name : String)
    {
        ...
        "D.Va"->
        {
            ...
            list2.add(getString(R.string.dva_gun_type))
            list2.add(getString(R.string.dva_gun_Damage))
            list2.add(getString(R.string.dva_gun_Falloff))
            list2.add(getString(R.string.dva_gun_Spread))
            list2.add(getString(R.string.dva_gun_pellets))
            list2.add(getString(R.string.dva_gun_movespeed))
            list2.add(getString(R.string.dva_gun_ROF))
            list2.add(getString(R.string.dva_gun_can_headshot))
            ...
            list3.add(getString(R.string.dva_defense_matrix_detail))
            list3.add(getString(R.string.dva_defense_matrix_range))
            list3.add(getString(R.string.dva_defense_matrix_duration))
            list3.add(getString(R.string.dva_defense_matrix_recharge_rate))
            list3.add(getString(R.string.dva_defense_matrix_cooldown))
            ...
            list4.add(getString(R.string.dva_boosters_damage))
            list4.add(getString(R.string.dva_boosters_movespeed))
            list4.add(getString(R.string.dva_boosters_duration))
            list4.add(getString(R.string.dva_boosters_cooldown))
            ...
            list5.add(getString(R.string.dva_micro_missiles_damage))
            list5.add(getString(R.string.dva_micro_missiles_projectile_speed))
            list5.add(getString(R.string.dva_micro_missiles_AOE))
            list5.add(getString(R.string.dva_micro_missiles_ROF))
            list5.add(getString(R.string.dva_micro_missiles_Cooldown))
            ...
            list6.add(getString(R.string.dva_ultimate_cost))
            list6.add(getString(R.string.dva_ultimate_damage))
            list6.add(getString(R.string.dva_ultimate_radius))
            list6.add(getString(R.string.dva_ultimate_cast_time))
            ...
            list8.add(getString(R.string.dva_gun2_type))
            list8.add(getString(R.string.dva_gun2_damage))
            list8.add(getString(R.string.dva_gun2_projectile_speed))
            list8.add(getString(R.string.dva_gun2_ROF))
            list8.add(getString(R.string.dva_gun2_ammo))
            list8.add(getString(R.string.dva_gun2_reloadspeed))
            list8.add(getString(R.string.dva_gun2_canheadshot))
            ...
            list9.add(getString(R.string.dva_ultimate2_cost))
            list9.add(getString(R.string.dva_ultimate2_damage))
            list9.add(getString(R.string.dva_ultimate2_cast_time))
