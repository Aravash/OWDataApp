...
import com.example.testapp.ExpandableListAdapter
...
class heroDetailFragment : Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val expandable: ExpandableListView = inflate.findViewById(R.id.ExpandableView)

        val bundle = arguments
        val message = bundle!!.getString("message")

        if (message != null) {
            generateExpandable(message)
        }
        expandable.setAdapter(ExpandableListAdapter(requireContext(), expandable, header, headerImages, body))
